...
let fiftyWomenData = {
  ...
  texts_backup: [
    "בדור שלי, מיניות היה דבר שנעשה בחדרי חדרים, בהיחבא… לא מטלה שמסמנים עליה וי, ושגם לי מגיע ליהנות מזה",
    "בניגוד לגברים שיכולים להתחרמן תוך 30 שניות מסרט כח…צליח לגרום לנשים למצוא את הקול והמיניות שלהן מחדש",
    "נשים בצד את הכתיבה האיומה ואת העובדה שיש פה גבר שמ… אותה בצורה הזאת ואז ראיתי ישועות'\" זה מאוד פרקטי",
    "זה שיחרר אצלי מקום נעול ואיפשר לי להשלים עם הגוף ו…יניות בצורה חופשית יותר, גם עם החברות וגם עם בעלי",
    "עברנו כברת דרך בעשור האחרון, והיום זה כבר לא באמת …הנאה לשניהם עם המון מקום למשחק המקדים, וזה פנטסטי",
    'כשהייתי העורכת הראשית של "ידיעות ספרים", התעוררתי …אחרי כבר נמכרו זכויות התרגום בגרמניה במיליון דולר',
    'כדוברת של "ידיעות ספרים", היה לי ברור שיש כאן משהו…תוך יומיים נמכרו 5,000 עותקים. תוך שבועיים 20 אלף',
    "נתקלתי בפרק הראשון בעיתון סוף השבוע, ובשבת כבר טסת…ה קריאה של הקלאסיקות הגדולות ומתפרנסת מכתיבה בלבד",
    "הגלולה למניעת היריון התפוצצה בסוף שנות ה-50 ובתחיל…רו. והדבר הזה איפשר שינוי חברתי מאוד מוצלח ומשחרר",
    "עד לפני שבע שנים לא קראתי ספרים שלא קשורים לדת, וב…מאז שהתחלתי לקרוא, היחסים שלי עם בעלי השתפרו מאוד",
    'נסעתי עם אבא שלי להשתלת כליה בחו"ל. סיטואציה לא נע…תאום התחלתי להסתכל על הכריכות והבנתי מה היא קוראת',
    "אני מגיעה מבית דתי, מעולם לא ראיתי פורנו, ופתאום נ…מיות, שמותר לי לנסות דברים בלי להרגיש שזה לא בסדר",
    "הספר הזה פונה למכנה המשותף הרחב ביותר, ומי שמזלזל …כדי שנתרשם מהמילה הכתובה, הדגדגן הוא מה שחשוב כאן",
    "יש תנועה של נשים שאומרת בקול שהגיע הזמן להפסיק עם …יש אשמה והפסיק להיות לי אכפת. היום אני פשוט נהנית",
    'העשור שהתחיל בשנות האלפיים עם "הארי פוטר" ו"דמדומי…נים ההיררכיים של שיווק, פרסום, ביקורת והוצאה לאור',
    'בניית העולם ב"50 גוונים" סחפה אותי, והרגשתי שאני צ… פשוט להיפתח. במובן מסוים, "50 גוונים" נתן לי קול',
    'תמיד קראתי המון, אבל "50 גוונים" היה מבחינתי טאבו.…טיות שלי ירדה והתחלתי להיחשף לעולמות ואנשים חדשים',
    '"50 גוונים" פתח פתח לנשים לכתוב על סקס, וזה אקט מא…אצל מי הניסיון מסתכם בכך שהיא קראה את "50 גוונים"',
    "הייתי בטוחה שהוא יהיה גרוע, והופתעתי מאוד. הרגשתי …מין. ככה צעירים באמת חווים ריגוש מיני חדש וראשוני",
    "בגיל 20 הכרתי את בעלי ומאז אנחנו יחד. הכל היה מאוד…ית הגג שיצליף בהן. זה ממש שיחרר את הפקקים האסורים",
    "נשאבתי אליו כמו שבחיים לא נשאבתי, הרגשתי שאני איתם…מהספרים והוא זורם איתי. הספר הזה שינה לי את החיים",
    '"50 גוונים" כתוב בשפה פשוטה שפונה לקהל הרחב, זה של…ום התחלתי ליזום. זה עורר משהו שהיה רדום אצלי שנים',
    "אני לא אדם כל כך ונילה, אם לצטט את מר גריי, והספר …ים בספרים. אחרי הכל, אם הם בני ביצוע - אז למה לא?",
    "תמיד אהבתי רומנים רומנטיים מהסוג של נורה רוברטס, א…יראו לקוראות מה קורה מאחורי הדלת, באופן הכי חופשי",
    'עד "50 גוונים" לא הייתי בקטע של ספרים, ופתאום קראת…ר בדיבור על סקס עם חברות, עם בעלי וביני לבין עצמי',
    "יש לי לקויות למידה, בעיה בקריאה והפרעת קשב, ודווקא… קליל ומגניב שעשה ספתח לז'אנר שלם שלא ידעתי שקיים",
    '"50 גוונים" גרם לי לגלות את המיניות שלי, ובעקבותיו… הבין מה נחת עליו. אמרתי, "זה מהספרים שאני קוראת"',
    '"50 גוונים" יצא לפני עידן מי טו, שעם כל ההישגים הע…ניים התרבותיות שמנסות למשמע אותנו - יסתכלו גם עלי',
    "אחת לכמה שנים מתפוצצת בעולם הספרות תופעה שהופכת לב…תורי ענק של נשים עם סלים רב־פעמיים שמשתרכים מולם.",
    "נשים עדיין משלמות מחיר על המיניות שלהן, לא חשוב מה…ועת מטוטלת שמגדירה מחדש את מערך הכוחות בין המינים",
    'קראתי את "50 גוונים" בצבא, וממנו הגעתי לקבוצות הרו…ות רק על ספרים, זו משפחה, שאנחנו מדברות בה על הכל',
    '"50 גוונים" נתן הצצה לדברים שאנשים לא ידעו שיש להם… לרצות ללמוד, לשמוע הרצאות, ולהרחיב את הידע בנושא',
    "הספרים הללו שמרניים ומסוכנים, ומנציחים את הסיפור ש…. כל מה שקשור לבטיחות והסכמה נעדר מהסיפור לחלוטין",
    'השיחה הראשונה שלי עם דנה, שמנהלת איתי את קבוצת "כל…רות שמהוות כוח קנייה מטורף עם השפעה אדירה על הענף',
    "יום אחד בעלי נכנס הביתה וסיפר שקולגה נכנס לאוטו של…ותו למדורת שבט מינית נשית ותרמה מאוד לפתיחות בשיח",
    'מה שזכור לי מהספר היא המילה "שיואו" שהופיעה בכל פס… הרבה יותר ליברלים והמיניות היתה הרבה יותר מובהקת',
    '"50 גוונים" ריתק אותי, והתחלתי לחפש בפייסבוק עוד ב…אותו הקטע, שאפשר לדבר איתן ולפרוק. זה ענק מבחינתי',
    'הטרנד של "50 גוונים" היה כל כך דומיננטי שאי אפשר ה…, או מהמרחב שבו אנחנו נמצאים, אל אותו מרחב פנטזיה',
    "לספר היתה השפעה מדהימה בפתיחה ובלגיטימיות של השוק …טימציה לכתוב ספרות קינקית מגיעה מהתפוצה הרחבה שלו",
    "פתאום הגיעו נשים שמעולם לא ביקרו בחנויות לצעצועי מ…צא הספר, כל לקוחה שנייה חיפשה ערכת קשירה למתחילים",
    'בדס"ם מוצג בספר כפתולוגיה דרך זה שהוא מחובר אצל גר…י בעיניי שהחוזה ביניהם לא נחתם, כי היא באמת לא שם',
    "היה פה פלח אוכלוסייה שלא העלה על דעתו שאפשר לקרוא …דים, אנשי זאב, דמויות א-בינאריות או זוגות בפרק ב'",
    "לא רק שהספר פתח את הדלת לז'אנר הרומנטי, הוא גם פתח…כרתי בקבוצות שתי חברות נפש שכבר מזמן נהפכו למשפחה",
    "גריי הוא הגיבור הראשון שהתייחס לווסת של הגיבורה וש…ספר הזה החזיר לי את הרצון לקרוא ולהישאב לעולם אחר",
    "קראתי את הספר כי הבנתי שהוא מעורר שיח ומעלה שאלות …שי ואת היכולת לדבר עליו, וזה כשלעצמו אקט פמיניסטי",
    "הספר יצר מסלול עוקף פורנו. בעולם שבו עדיין שולט הפ…כמודל אהוב - המסר עובר, וזה משהו שצריך לחשוב עליו",
    'הספר הגיע בתקופה שבה נשים התחילו לתפוס את הערך שלה…ם" ויצר שיטפון מטורף של נשים שיצאו מהארון הרומנטי',
    "בהתחלה לא הבנתי מה הסיפור של ספר על סקס, אבל מהרגע…ות להביא, ולמרות שזה היה מפחיד - פשוט הלכנו על זה",
    "חברה העבירה לי את הספר, והתלהבתי ברמה שקראתי את הט… זה הפתרון. אי אפשר לראות או לפגוש אותו, רק לפנטז",
    '"50 גוונים" היה פורץ דרך. זה כבר לא הרומן הרומנטי …ינטימיות לשלב הבא. הוא פתח את הצ\'אקרות להמון נשים',
  ],
